...
const MarkdownDownloadSection = ({
  ...
  const [isDownloading, setIsDownloading] = useState<"html" | "pdf" | null>(
    null
  );
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="p-4 border border-border/50 rounded-lg hover:shadow-md transition-all duration-200">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground">HTML File</h3>
              ...
              <div className="p-4 border border-border/50 rounded-lg hover:shadow-md transition-all duration-200">
                <div className="flex items-center space-x-3 mb-3">
                  <div className="p-2 bg-gradient-to-br from-red-100 to-red-200 dark:from-red-900/20 dark:to-red-800/20 rounded-lg">
                    <Image className="h-5 w-5 text-red-600 dark:text-red-400" />
                  </div>
                  <div>
                ...
                <div className="space-y-3">
                  <div className="text-xs text-muted-foreground">
                    • {conversionOptions.pdfPageSize.toUpperCase()} page size •{" "}
                    {conversionOptions.pdfMargins} margins • High-quality output
                    {conversionOptions.includePageNumbers && (
                      <>
                        <br />• Page numbers
                      </>
                    )}
